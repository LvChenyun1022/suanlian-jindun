...
|---|---|---|---|---|
| R77-001 | 77号文 第九条 第(一)项 | 账期超过 183 天，提示关注长期挂账与回款风险 | `account_days > 183` | medium（提示） |
| R77-002 | 77号文 第九条 第(二)项 | 账期超过 365 天，构成违规长期融资性挂账 | `account_days > 365` | high（违规） |
| R77-003 | 77号文 第十二条 第(二)项 | 三单核验不一致，贸易背景真实性存疑 | 任一三单核验项 fail | high |
| R77-004 | 77号文 第十五条 第(三)项 | 同一主体 30 天内多笔金额接近登记阈值，疑似拆分规避 | 窗口内 ≥2 笔且金额 ∈ [阈值×0.8, 阈值) | medium（提示） |
| R77-005 | 77号文 第十八条 第(一)项 | 租赁物在动产融资登记中存在冲突登记（一单多押风险） | 租赁物编号跨案件重复 / 模拟登记冲突 | block |

注：R77-005 的动产登记查询为**模拟接口**（跨案件编号查重 + 本地 mock 登记数据），
